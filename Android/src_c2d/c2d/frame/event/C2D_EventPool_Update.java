...
public class C2D_EventPool_Update extends C2D_EventPool
{
	public C2D_EventPool_Update(C2D_Widget carrier)
	{
		super(carrier);
	}
	/**
	...
	public final void onCalled()
	{
		...
		if(events!=null)
		{
			for(int i=0;i<events.size();i++)
			{
				...
				{
					C2D_Event_Update event = (C2D_Event_Update)message.m_event;

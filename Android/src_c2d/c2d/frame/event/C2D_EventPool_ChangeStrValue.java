...
public class C2D_EventPool_ChangeStrValue extends C2D_EventPool
{

	public C2D_EventPool_ChangeStrValue(C2D_Widget carrier)
	{
		super(carrier);
	}
	/**
	 ...
	 */
	public final void onCalled(String newValue)
	{
		...
		if(events!=null)
		{
			for(int i=0;i<events.size();i++)
			{
				...
				{
					C2D_Event_ChangeStrValue event = ((C2D_Event_ChangeStrValue)message.m_event);
	 ...
	 */
	public boolean add(C2D_Event_ChangeStrValue event)
	{

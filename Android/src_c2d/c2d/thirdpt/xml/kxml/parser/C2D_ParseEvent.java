...
public class C2D_ParseEvent {
    ...
    public C2D_ParseEvent (int type, String text) {
	this.type = type;
	this.text = text;
    }
   ...
   /** In the event type is START_TAG, this method returns the attribute 
    ...
    public C2D_XmlAttribute getAttribute (int index) {
	return (C2D_XmlAttribute) getAttributes().elementAt (index);
    }
    
    /** returns the local attribute with the given name.  convenience
	method for getAttribute (Xml.NO_NAMESPACE, name); */

    public C2D_XmlAttribute getAttribute (String name) {
	return getAttribute (C2D_Xml.NO_NAMESPACE, name);
    }
    ...
    public C2D_XmlAttribute getAttribute (String namespace, String name) {
	...
	C2D_XmlAttribute attr = getAttribute (attrName);

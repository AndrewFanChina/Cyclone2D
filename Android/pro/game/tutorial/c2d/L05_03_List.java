...
public class L05_03_List extends C2D_FpsScene
{
	public L05_03_List()
	{
	}
...
//		list.setIconList(iconList);
		//设置列表的条目背景图
		C2D_ListStyle bgImgCfg = new C2D_ListStyle(new C2D_ImageClip("guangbiao.png"),
				new C2D_PointI(50, 50), C2D_Consts.HCENTER|C2D_Consts.VCENTER);
		list.setStyle(bgImgCfg, null);
		//添加内容条目
